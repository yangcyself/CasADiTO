// Authors:  Chenyu Yang 2021-4-28

#ifndef __TONLP_HPP__
#define __TONLP_HPP__
...
public:
   ...
   /** Default constructor */
   TONLP(
      parseOutput::x_plot& x_output,
      parseOutput::u_plot& p_output,
      const hp_t& hyParam
   );
...
private:
   ...
   parseOutput::x_plot& _x_output;   
   parseOutput::u_plot& _p_output;   
